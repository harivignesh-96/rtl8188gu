...
echo -e "\n${cyan}[*] Please report any bugs/problems at https://github.com/McMCCRU/rtl8188gu"
echo ""
...
if pciDetectsRtl8188gu || pciDetectsRtl8192ce; then
    input="y"
    if pciDetectsRtl8188gu; then
        CARD="RTL8188GU"
    ...
    read -p "[*] Is your wireless card either the RTL8188GU or RTL8192CE? (Y/N): " input
fi
